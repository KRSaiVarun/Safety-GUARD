...
@app.post("/api/v1/emergency/submit-location")
...
@app.post("/api/v1/emergency/verify-passcode")
...
@app.post("/api/v1/emergency/send-alert")
...
@app.get("/api/v1/emergency/{session_id}")
...
@app.get("/api/v1/emergency/{session_id}/locations")
...
@app.get("/api/v1/emergency/{session_id}/analysis")
