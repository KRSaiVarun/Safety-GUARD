    ...
    <nav className={styles.nav}>
      <div className={styles.inner}>
        ...
        <Link to="/" className={styles.logo}>
          ...
          <span>
            Safety<span className={styles.logoAccent}>GUARD</span>
          </span>
        </Link>
        ...
        {/* Socket status */}
        <div className={styles.socketStatus} title={`Socket: ${socketStatus}`}>
          <span
            className={`${styles.socketDot} ${styles[socketStatus] ?? ""}`}
          />
        ...
        {user && (
          <div className={styles.links}>
            ...
            <Link
              to="/emergency"
              className={`${styles.link} ${styles.linkEmergency}`}
            >
